...
- [x] Package Killer (+3) — Express reimplementation, this is the core idea
- [x] STDLIB Log (+3) — 15 meaningful substitutions documented in STDLIB.md
...
- **No project code committed before kickoff** (28 Aug 2026, 6:30 PM IST). Docs/scaffolding are fine before that; `src/` implementation is not.
